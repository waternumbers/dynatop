...
## START HERE:
## Check parameter values and option settings
...
dynatop <- R6::R6Class(
    ...
    private = list(
        ...
        ## - output_label
        type_options = list(
            hillslope = list(type_sz = c("exp","cnst","bexp"))
        ),
        model_description = list(
            ## hillslope data frame
            hillslope = data.frame(
                name = c("id","atb_bar","s_bar","area","width","type_sz", ## attributes associated with hru
                         "r_sfmax","c_sf","s_rzmax","s_rz0","t_d","r_uz_sz0","ln_t0","c_sz","m","D", ## parameters
        ...
        digest_model = function(model,use_states){
            ...
            ## convert types into integer values
