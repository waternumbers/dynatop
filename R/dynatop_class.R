...
dynatop <- R6Class(
    ...
    private = list(
        ...
        hs_step <- function(ii){}
            ...
            integral_flux=list(),
            par=list(),
        ## surface excess parts
        ex=list(setup=function(){return(NA)},
                step=function(){return(NA)},
                expAdt=NULL,
                s_0=NULL,
                s_dt=NULL,
                idx=NULL
        ...
        ## root zone parts
        rz=list(step=function(){return(NA)}),
        ## unsaturated zone parts
        uz=list(step=function(){return(NA)}),
        ## saturated zone parts
        sz=list(step=function(){return(NA)}),
        ...
        value
                   ...
                   function(model,obs_data,initial_recharge=NA,sim_time_step=NULL, use_states=FALSE){
