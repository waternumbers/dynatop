#' Example dynamic TOPMODEL setup for the Brompton catchment
#'
#' @description
...
#' # Show it
#' # plot(obs_data)
#' @format An environment comprising the required model variables and example data necessary to run the model.
#'
#' @seealso \code{\link{dynatop}}
"brompton"
