...
channel. This document is concerned only with the solution of the "hill slope" HRUs. It does not deal with the routing of the water within the channel. As such channel HRUs acts as sinks collecting water from the "hill slope" HRUs over the course of a time step. Table \@ref(tab:ch-notation) outlines
