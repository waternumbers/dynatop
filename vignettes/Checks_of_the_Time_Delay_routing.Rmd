...
sim_inflows <- dynatop(test_catchment$model,test_catchment$obs,0.0015)$channel_input
plot(ex_inflows,title="Basic inflows set")
```

# Check the time delays
```{r time_delay}
compute_time_delay(test_catchment$model)
```
