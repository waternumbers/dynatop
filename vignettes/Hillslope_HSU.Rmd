...
Assuming lateral flux is proportional to storage and taking $l_{sf} = \frac{s_{sf}}{T_{sf}}$ gives
\begin{equation}
T_{sf} \frac{dl_{sf}}{dt} = -\frac{dl_{sf}}{dx} - r_{sf \rightarrow rz}
\end{equation}
...
\begin{equation}
wT_{sf}\frac{dl_{sf}}{dt} = \frac{1}{\Delta x}\left(q_{sf}^{-} - wl_{sf}\right) - wr_{sf \rightarrow rz}
\end{equation}
or more conviently
\begin{equation}
T_{sf}\frac{dl_{sf}}{dt} = \frac{1}{\Delta x}\left(\frac{q_{sf}^{-}}{w} - l_{sf}\right) - r_{sf \rightarrow rz}
\end{equation}
...
where
\begin{equation}
\lambda_{sf} = \frac{\Delta t}{T_{sf} \Delta x}
\end{equation}
and
\begin{equation}
