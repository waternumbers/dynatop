...
\@ref{tbl:surface} with their parameters outlined in Table
\@ref{tbl:surface-param}

| Type | Description                                                           | Parameters   | \mathcal{F}\left(s_{sf},\Theta_{sf}\right)                                   | \mathcal{F}_{\eta}\left(s_{sf},\Theta_{sf}\right) |
|------|-----------------------------------------------------------------------|--------------|------------------------------------------------------------------------------|---------------------------------------------------|
| cnst | Linear Tank coupled below a constant parameter diffusive wave solution | $v_sf, k_sf$ | \[q_{sf}  =\left\{ \begin{array}{cl} s_{sf}/t_{raf} & s_{sf} \leq s_{raf} \\ s_{raf}/t_{raf} + (s_{sf}-s{raf}|                                                   |
| kin  | Linear tank with Kinematic Wave for remaining flow                    |              |                                                                              |                                                   |

Table: (\#tbl:surface) Outline formulations for the storage-flow relationship in the surface zone.
...
Table: (\#tbl:surface-param) Parameters used in the surface zone storage-flow
relationships.
