...
|------|------------------------------------------------------------------------|-----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| cnst | Linear Tank coupled below a constant parameter diffusive wave solution | $t_{raf}, s_{raf},c_{sf}, d_{sf}$ | \[ \left\{ \begin{array}{cl} \frac{s_{sf}}{t_{raf}} & s_{sf} \leq s_{raf} \\ \frac{s_{raf}}{t_{raf}} + \frac{c_{sf}}{\Delta x}(s_{sf}-s_{raf}) & \mathrm{otherwise} \end{array} \right.\] | $\frac{1}{2} - \frac{d_{sf}}{c_{sf}\Delta x}$        |
| kin  | Linear tank with Kinematic Wave for remaining flow                     | TODO                              |                                                                                                                                                                                           | TODO                                                |
