...
\[
\frac{ds_{sf}}{dt} = \frac{1}{1-\eta_{sf}} q^{-} 
- r_{sf \rightarrow rz} 
- \frac{\kappa_{sf}}{1 - \eta_{sf}} s_{sf}
\]

Several interpretations of the scheme suiitable for the surface zone
are given in Table \@ref(tab:hs-sf-notation).
...
\begin{equation}
\frac{d \left(D-s_{sz}\right)}{dt} = \frac{1}{2} q^{-} 
+ r_{uz \rightarrow sz} 
- \frac{\kappa_{sz}}{2} \left(D-s_{sz}\right)
\end{equation}

or treating $D$ as constant and subsituting in the expression for
$r_{uz \rightarrow sz}$

\[
\frac{d s_{sz}}{dt} = -\frac{1}{2} q^{-} 
...
The Kinematic approximation then depends upon the specification of a
 relationship between lateral flow and storage deficit on a given
 cross section expressed as a height $h_sz$.
 This usually termed the transmissivity
 profile and defines a relationship through a one-to-one, continuously differentiable function 
