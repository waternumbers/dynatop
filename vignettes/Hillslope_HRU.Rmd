...
| ----                | ----                                                                                                                           | ----                                                        | ----              | ----            | ----                                                         |
| Exponental          | $T_{0}\sin\left(\beta\right)\exp\left(-\frac{\cos\beta}{m}s_{sz}\right)$                                                       | $\frac{\cos\beta}{m}g\left(\bar{s}_{sz},\Theta_{sz}\right)$ | $T_0,\beta,m$ | `"exponential"` | Originally given in [Beven & Freer 2001](http://example.com) |
| Bounded Exponential | $T_{0}\sin\left(\beta\right)\left(\exp\left(-\frac{\cos\beta}{m}s_{sz}\right)
 - \exp\left(-\frac{\cos\beta}{m}D\right)\right)$ | $\frac{cos
   \beta}{m}T_{0}\sin\left(\beta\right)\exp\left(-\frac{\cos\beta}{m}s_{sz}\right)$ | $T_0,\beta,m,D$ | `"bounded_exponential"` | Originally given in [Beven & Freer 2001](http://example.com) |
