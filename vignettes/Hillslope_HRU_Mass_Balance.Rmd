---
title: "Hillslope HRU mass balance checks"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Hillslope HRU mass balance checks}
...
```
The purpose of this vignette is to demonstrate the simulation of mass balance
checks on the computation of hillslope elements. It provides both a check for
