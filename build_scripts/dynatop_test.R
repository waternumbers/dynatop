...
swindale_model <- readRDS("../dynatopGIS/build_scripts/demo/new_model.rds")


ii <- 2
Swindale$model$hru[[ii]]$properties
swindale_model$hru[[ii]]$properties
Swindale$model$hru[[ii]]$sf
swindale_model$hru[[ii]]$sf
Swindale$model$hru[[ii]]$init
swindale_model$hru[[ii]]$init
Swindale$model$hru[[ii]]$sz
swindale_model$hru[[ii]]$sz
Swindale$model$hru[[ii]]$sf_flow_direction
swindale_model$hru[[ii]]$sf_flow_direction
...
#    system.file("extdata","Swindale.tif",package="dynatop",mustWork=TRUE)
...
for(ii in 1:length(hru)){
    if( !("endNode" %in% names(hru[[ii]]$class)) ){
        ...
        ## saturated zone parameters
        hru[[ii]]$sz$parameters["t_0"] <- 1e-16#0.001
        ## root zone parameters
...
#outdef <- swindale_model$output_flux
#outdef <- rbind(outdef,outdef)
#outdef$flux[2] <- "q_sz"

#sim1 <- ctch_mdl$sim(outdef)$get_output()
